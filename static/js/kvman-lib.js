        ...
        $.ajax({
            ...
            success: function (resp) {
                ...
                if (code === 0) {
                    ...
                    layer.close(index);
                    layer.alert('设置失败，请稍后再试！', {title: 'KvMan提示', icon: 3});
                }
            },
            error: function () {
                layer.close(index);
    ...
    $.ajax({
        ...
        success: function (resp) {
            ...
            if (code === 0) {
                ...
                layer.alert('获取远程连接失败，请稍后再试！', {title: 'KvMan提示', icon: 3});
            }
        },
        error: function () {
            layer.alert('系统繁忙，请稍后再试！', {title: 'KvMan提示', icon: 3});
